...
const displayLevelWords = (words) => {
    ...
    words.forEach((word) => {
      ...
      <div onclick="loadWordDetails(${word.id})" class="flex justify-between items-center">
...
document.getElementById("btn-search").addEventListener("click", ()=>{
    ...
    fetch("https://openapi.programming-hero.com/api/words/all")
        ...
        .then(data=>{
            ...
            const filtererWords=allWords.filter(word=>word.word.toLowerCase().includes(searchValue));
            console.log(filtererWords);
        });
        displayLevelWords(filtererWords);
});
